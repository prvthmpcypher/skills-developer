...
description: >-
  Specialist workflow for Drupal Shopping Cart. Use when the user asks about drupal shopping cart, needs this workflow, or requests related deliverables.
---
...
- Stay specific to the Drupal Shopping Cart workflow; avoid generic filler.
