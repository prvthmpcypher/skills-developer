...
description: >-
  Specialist workflow for Incident Responder. Use when the user asks about incident responder, needs this workflow, or requests related deliverables.
---
...
- Stay specific to the Incident Responder workflow; avoid generic filler.
